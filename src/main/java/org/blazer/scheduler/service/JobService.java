...
public class JobService {
	...
	@Transactional
	public void updateJobCommand(Integer jobId, String command) throws Exception {
		String sql = "update scheduler_job set command=? where id=?";
		jdbcTemplate.update(sql, command, jobId);
	}
